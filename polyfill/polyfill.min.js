!(function () {
                                ...
                                (a.append = function (t, e) {
                                    ...
                                    (a.forEach = function (t, e) {
                                        ...
                                        for (var r in this._entries)
                                            if (
                                                this._entries.hasOwnProperty(r)
                                            ) {
                                                n = this._entries[r];
                                                for (
                                                    var o = 0;
                ...
                default: function () {
                    !(function () {
                        ...
                        function e(t, e) {
                            ...
                            return (
                                n.initEvent(t, !!e.bubbles, !!e.cancelable), n
                            );
                        }
    ...
    function A(t, e) {
        if (!t) {
            for (
                ...
                r[o - 2] = arguments[o];
            throw new TypeError(k(e, r));
        }
    }
    function k(t, e) {
        var n = 0;
        return t.replace(/%[os]/g, function () {
            return F(e[n++]);
        });
    }
    function F(t) {
    ...
    var I,
        ...
        U = new B("W01", "Unable to initialize event under dispatching."),
        L = new B(
            "W02",
        ...
        C = new B("W04", "Unable to preventDefault on non-cancelable events."),
        N = new B(
            "W05",
    ...
    new B("W09", "Event attribute handler must be a function: %o");
    var W = (function () {
            function t(e, n) {
                r(this, t),
                ...
                Y.set(this, {
                    type: String(e),
                    bubbles: Boolean(o.bubbles),
                    cancelable: Boolean(o.cancelable),
                    composed: Boolean(o.composed),
                    target: null,
                    currentTarget: null,
                ...
                i(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = $(this);
                                t.stopPropagationFlag =
                                    t.stopImmediatePropagationFlag = !0;
                            },
                        },
                        {
                            key: "bubbles",
    ...
    function K(t) {
        t.inPassiveListenerFlag
            ? N.warn()
            : t.cancelable
            ? (t.canceledFlag = !0)
            : C.warn();
    }
    Object.defineProperty(W, "NONE", { enumerable: !0 }),
        Object.defineProperty(W, "CAPTURING_PHASE", { enumerable: !0 }),
        Object.defineProperty(W, "AT_TARGET", { enumerable: !0 }),
        Object.defineProperty(W, "BUBBLING_PHASE", { enumerable: !0 });
    for (
        var Q, Z = Object.getOwnPropertyNames(W.prototype), J = 0;
        J < Z.length;
        ++J
    )
        "constructor" !== Z[J] &&
            Object.defineProperty(W.prototype, Z[J], { enumerable: !0 });
    void 0 !== D &&
        void 0 !== D.Event &&
        Object.setPrototypeOf(W.prototype, D.Event.prototype);
    var tt = {
        INDEX_SIZE_ERR: 1,
    ...
    var nt = (function (t) {
            ...
            function n(t) {
                ...
                r(this, n),
                    ...
                    rt.set(h(a), { original: t });
                for (var u = Object.keys(t), s = 0; s < u.length; ++s) {
                    var l = u[s];
                    l in h(a) || Object.defineProperty(h(a), l, ut(t, l));
                }
                return a;
            }
            return (
                    ...
                    [
                        {
                            key: "stopPropagation",
                            value: function () {
                                v(c(n.prototype), "stopPropagation", this).call(
                                    this
                                );
                                var t = ot(this).original;
                                "stopPropagation" in t && t.stopPropagation();
                            },
                        },
                        {
                            key: "cancelBubble",
                            get: function () {
                                return v(c(n.prototype), "cancelBubble", this);
                            },
                            set: function (t) {
                                m(c(n.prototype), "cancelBubble", t, this, !0);
                                var e = ot(this).original;
                                "cancelBubble" in e && (e.cancelBubble = t);
                            },
                        },
                        {
                            key: "stopImmediatePropagation",
                        ...
                        },
                        {
                            key: "returnValue",
                            get: function () {
                                return v(c(n.prototype), "returnValue", this);
                            },
                            set: function (t) {
                                m(c(n.prototype), "returnValue", t, this, !0);
                                var e = ot(this).original;
                                "returnValue" in e && (e.returnValue = t);
                            },
                        },
                        {
                            key: "preventDefault",
                            value: function () {
                                v(c(n.prototype), "preventDefault", this).call(
                                    this
                                );
                                var t = ot(this).original;
                        ...
                        },
                        {
                            ...
                            get: function () {
                                ...
                                return "timeStamp" in t
                                    ? t.timeStamp
                                    : v(c(n.prototype), "timeStamp", this);
                            },
                        },
                    ],
                    [
    ...
    function ot(t) {
        var e = rt.get(t);
        return (
            A(null != e, "'this' is expected an Event object, but got", t), e
        );
    }
    var it = new WeakMap();
    function at(t) {
            ...
            null == n &&
                ((n = (function (t, e) {
                    for (
                        ...
                        Object.defineProperty(n.prototype, o[i], ut(e, o[i]));
                    return n;
                })(at(e), e)),
                it.set(e, n)),
            n
    ...
    function ht(t, e, n) {
        ...
        try {
            "function" == typeof r
                ? r.call(e, n)
                : "function" == typeof r.handleEvent && r.handleEvent(n);
        } catch (t) {
            !(function (t) {
                try {
                    var e = t instanceof Error ? t : new Error(F(t));
                    if (
    ...
    function yt(t, e, n) {
        for (var r = t.listeners, o = 0; o < r.length; ++o)
            if (r[o].callback === e && st(r[o]) === n) return o;
        return -1;
    }
    function dt(t, e, n) {
        var r = yt(t, e, n);
    ...
    function bt(t, e) {
        ...
        return (
            ...
            t.cow && !n
                ? ((t.cow = !1),
                  (t.listeners = t.listeners.filter(function (t, n) {
                      return n !== e;
                  })),
                  !1)
                : (t.listeners.splice(e, 1), !0)
        );
    }
    it.set(Object.prototype, nt),
        void 0 !== D && void 0 !== D.Event && it.set(D.Event.prototype, nt);
    var vt = (function () {
            function t() {
                r(this, t), gt.set(this, Object.create(null));
            }
            return (
                i(t, [
                    {
                        ...
                        value: function (t, e, r) {
                            var o = mt(this),
                                i = (function (t, e, r) {
                                    var o;
                                    if (
                                        (wt(e), "object" === n(r) && null !== r)
                                    )
                                        return {
                                            type: String(t),
                                            callback: null != e ? e : void 0,
                            ...
                            if (
                                ...
                                -1 === h
                                    ? (function (t, e, n, r, o, i) {
                                          var a;
                                          i &&
                                              ((a = dt.bind(null, t, e, n)),
                                              i.addEventListener("abort", a));
                                          var u = (function (t, e, n, r, o, i) {
                                              return {
                                                  callback: t,
                                                  flags:
                                                      (e ? 1 : 0) |
                                    ...
                                    : (function (t, e, n, r) {
                                          M.warn(
                                              ...
                                              lt(t) !== e && H.warn("passive");
                                          ft(t) !== n && H.warn("once");
                                          t.signal !== r && H.warn("signal");
                                      })(p.listeners[h], s, c, l);
                            }
                        },
                    },
                    ...
                    },
                    {
                        key: "dispatchEvent",
                        value: function (t) {
                            var e = mt(this)[String(t.type)];
                            if (null == e) return !0;
                            var n,
                                o = t instanceof W ? t : nt.wrap(t),
                                a = $(o, "event");
                            if (a.dispatchFlag)
                                throw (
                                    ((n =
                            ...
                            if (
                                ...
                                for (var l = 0; l < s.length; ++l) {
                                    ...
                                    if (
                                        !pt(f) &&
                                        (ft(f) && bt(e, l, !c) && (l -= 1),
                                        (a.inPassiveListenerFlag = lt(f)),
                                        ht(f, this, o),
                                        (a.inPassiveListenerFlag = !1),
                                        a.stopImmediatePropagationFlag)
                                    )
                                        break;
                                }
                                c || (e.cow = !1);
                            ...
                            return (
                                ...
                                (a.stopImmediatePropagationFlag = !1),
                                (a.stopPropagationFlag = !1),
                                (a.dispatchFlag = !1),
                                !a.canceledFlag
                            );
                        },
    ...
    function wt(t) {
        if (
            ...
            if (null != t && "object" !== n(t))
                throw new TypeError(k(G.message, [t]));
            G.warn(t);
        }
    }
    for (
        var Et = Object.getOwnPropertyNames(vt.prototype), _t = 0;
        _t < Et.length;
        ++_t
    )
        "constructor" !== Et[_t] &&
            Object.defineProperty(vt.prototype, Et[_t], { enumerable: !0 });
    void 0 !== D &&
        void 0 !== D.EventTarget &&
        Object.setPrototypeOf(vt.prototype, D.EventTarget.prototype);
    var Ot = O(
            Object.freeze({
                __proto__: null,
                default: function () {
                    "function" != typeof window.EventTarget &&
                        (window.EventTarget = vt);
                },
            })
        ),
        Pt = P;
    !(function () {
        ("function" == typeof Promise &&
            ...
            Pt("https://cdn.bootcss.com/babel-polyfill/7.6.0/polyfill.min.js"),
        ...
        "function" != typeof EventTarget && Ot();
    })();
    var jt = function (t) {
    ...
    var Bt = function (t, e) {
        ...
        Mt = St(function () {
            ...
            ? function (t) {
                  return "String" == xt(t) ? Ct.call(t, "") : Object(t);
              }
            : Object,
        Ht = Nt,
        Gt = function (t) {
        ...
        Vt = function (t, e) {
            ...
            if (
                ...
                return r;
            if ("function" == typeof (n = t.valueOf) && !Wt((r = n.call(t))))
                return r;
            if (
                !e &&
                "function" == typeof (n = t.toString) &&
    ...
    Rt.f = ee
        ? ce
        : function (t, e) {
              if (((t = oe(t)), (e = ie(e, !0)), ue))
                  try {
                      return ce(t, e);
                  } catch (t) {}
              if (ae(t, e)) return re(!ne.f.call(t, e), t[e]);
          };
    var se = St,
        le = /#|\.prototype\./,
        fe = function (t, e) {
            var n = he[pe(t)];
            return (
                n == de || (n != ye && ("function" == typeof e ? se(e) : !!e))
            );
        },
        pe = (fe.normalize = function (t) {
        ...
        Oe = te,
        Pe = function (t) {
            if (!Ee(t)) throw TypeError(String(t) + " is not an object");
            return t;
        },
        je = Vt,
    ...
    var Re = we,
        ...
        He = Math.floor,
        Ge = function (t) {
            return isNaN((t = +t)) ? 0 : (t > 0 ? He : Me)(t);
        },
        We = Ge,
        Ve = Math.min,
        ze = function (t) {
            return t > 0 ? Ve(We(t), 9007199254740991) : 0;
        },
        qe = Ne,
        Xe = ze,
        Ye = me,
        $e = function t(e, n, r, o, i, a, u, c) {
            for (var s, l = i, f = 0, p = !!u && Ye(u, c, 3); f < o; ) {
                if (f in r) {
                    if (((s = p ? p(r[f], f, n) : r[f]), a > 0 && qe(s)))
                        l = t(e, n, s, Xe(s.length), l, a - 1) - 1;
                    else {
        ...
        en = Tt[tn] || Je(tn, {});
    (Ke.exports = function (t, e) {
        return en[t] || (en[t] = void 0 !== e ? e : {});
    })("versions", []).push({
        version: "3.12.1",
        mode: "pure",
    ...
    var nn,
        ...
        ln = function (t, e) {
            return arguments.length < 2
                ? sn(un[t]) || sn(cn[t])
                : (un[t] && un[t][e]) || (cn[t] && cn[t][e]);
        },
        fn = ln("navigator", "userAgent") || "",
        pn = Tt.process,
        hn = pn && pn.versions,
        yn = hn && hn.v8;
    yn
        ? (rn = (nn = yn.split("."))[0] < 4 ? 1 : nn[0] + nn[1])
        : fn &&
          (!(nn = fn.match(/Edge\/(\d+)/)) || nn[1] >= 74) &&
          (nn = fn.match(/Chrome\/(\d+)/)) &&
          (rn = nn[1]);
    var dn = rn && +rn,
        bn = St,
        vn =
        ...
        gn = vn && !Symbol.sham && "symbol" == n(Symbol.iterator),
        mn = Tt,
        wn = Ke.exports,
        En = $t,
        _n = function (t) {
        ...
        jn = wn("wks"),
        Tn = mn.Symbol,
        Rn = Pn ? Tn : (Tn && Tn.withoutSetter) || _n,
        Sn = Gt,
        An = Ne,
        kn = (function (t) {
            return (
                (En(jn, t) && (On || "string" == typeof jn[t])) ||
                    (On && En(Tn, t)
                        ? (jn[t] = Tn[t])
                        : (jn[t] = Rn("Symbol." + t))),
                jn[t]
        ...
        Un = function (t, e) {
            ...
            return (
                An(t) &&
                    ...
                    (n !== Array && !An(n.prototype))
                        ? Sn(n) && null === (n = n[kn]) && (n = void 0)
                        : (n = void 0)),
    ...
    (function (t, e) {
        var r,
            ...
            h = t.stat,
            y = t.proto,
            d = p ? ke : h ? ke[f] : (ke[f] || {}).prototype,
            b = p ? De : De[f] || (De[f] = {}),
            v = b.prototype;
        for (i in e)
            (r =
                !Ie(p ? i : f + (h ? "." : "#") + i, t.forced) &&
                d &&
                Le(d, i)),
                (u = b[i]),
                r && (c = t.noTargetGet ? (l = Fe(d, i)) && l.value : d[i]),
                (a = r && c ? c : e[i]),
                (r && n(u) === n(a)) ||
                    ((s =
                        t.bind && r
                            ...
                            ? Be(Function.call, a)
                            : a),
                    (t.sham || (a && a.sham) || (u && u.sham)) &&
                        Ue(s, "sham", !0),
                    (b[i] = s),
                    y &&
                        (Le(De, (o = f + "Prototype")) || Ue(De, o, {}),
                        (De[o][i] = a),
                        t.real && v && !v[i] && Ue(v, i, a)));
    })(
        { target: "Array", proto: !0 },
        {
            flat: function () {
                var t = arguments.length ? arguments[0] : void 0,
                    ...
                    r = Un(e, 0);
                return (
                    (r.length = Fn(r, e, e, n, 0, void 0 === t ? 1 : Bn(t))), r
                );
            },
        }
    );
    var Ln = ln("Array", "flat");
    ...
    "function" != typeof Object.fromEntries && (Object.fromEntries = xn);
})();
