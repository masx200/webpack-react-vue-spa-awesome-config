...
var h = l.default.cwd(),
    w = ["public/index.html", "src/index.js", "public/favicon.ico"],
    x = w.map(function (e) {
...
function E(e, o, n) {
    c.default.existsSync(e) ||
        (o.unshift("webpack"),
        n("npx" + ("win32" === l.default.platform ? ".cmd" : "")));
}
...
var _,
    j = l.default.argv.slice(1),
    O = j.includes("start") ? "start" : j.includes("build") ? "build" : void 0,
    A =
        ((_ = {}),
        j
            .filter(function (e) {
...
console.log("\u89e3\u6790\u7684\u53c2\u6570:"),
    ...
    (function (e, o) {
        var n = o.config,
            ...
            r = n ? i.default.resolve(n) : t;
        Reflect.set(o, "config", r);
        var c,
            a,
            u = o.mode;
        if ("start" === e || "development" === u)
            (l.default.env.NODE_ENV = "development"),
                Reflect.set(o, "mode", l.default.env.NODE_ENV),
                b(x, k),
                E((c = m("webpack")), (a = ["serve"]), function (e) {
                    c = e;
                }),
                S(o, a),
                console.log("\n"),
